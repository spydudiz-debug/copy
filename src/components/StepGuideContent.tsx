            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between sm:gap-6">
              <div className="flex min-w-0 flex-1 gap-4">
                ...
                <div className="min-w-0">
                  <h2 className="text-xl font-bold tracking-tight text-[#0f172a] sm:text-2xl md:text-[1.625rem]">
                    {guide.title}
                  </h2>
                  <p className="mt-3 text-[0.9375rem] font-medium leading-relaxed text-[#64748b] sm:text-base">
                    {guide.intro}
                  </p>
                </div>
              </div>
