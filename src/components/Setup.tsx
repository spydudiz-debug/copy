  ...
  return (
    <Section id="setup-guide" className="bg-[#f5f5f7]">
      <Container>
        ...
        <div className="mt-14 border-t border-[#e5e7eb] pt-14 sm:mt-16 sm:pt-16 lg:mt-20 lg:pt-20">
          <h3 className="text-center text-[1.375rem] font-bold tracking-tight text-[#0f172a] sm:text-2xl md:text-3xl">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-center text-sm font-medium leading-relaxed text-[#6b7280] sm:mt-4 sm:text-[0.9375rem] md:text-base">
            Follow these steps to get from install to live channels on your device.
          </p>
            ...
            {setupSteps.map((s) => (
              ...
              >
                ...
                <div className="flex flex-1 flex-col p-4 sm:p-5">
                  ...
                  <h4 className="mt-1 text-lg font-bold text-[#0f172a]">{s.title}</h4>
