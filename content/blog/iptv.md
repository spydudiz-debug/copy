...
|--------|------------------------|
| Managed app + login | You install a provider’s app or a supported player, enter username/password or a portal URL. |
| Playlist-based | An M3U or M3U8 playlist lists stream addresses; a player loads the list. |
| Hybrid | Live channels plus catch-up and VOD in one interface. |
